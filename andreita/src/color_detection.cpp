...
void colorDetectionCallback(const sensor_msgs::ImageConstPtr& original_image)
{
    ...
    catch (cv_bridge::Exception& e)
    {
        ...
        ROS_ERROR("tutorialROSOpenCV::color_detection.cpp::cv_bridge exception: %s", e.what());
        return;
    }
...
int main(int argc, char **argv)
{
    ...
    */
    ...
    image_transport::Subscriber sub = it.subscribe("/usb_cam/image_raw", 1, colorDetectionCallback);
    ...
    */
    ...
    ROS_INFO("tutorialROSOpenCV::color_detection.cpp::No error.");
