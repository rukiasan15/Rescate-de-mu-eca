...

{
        ...
        if ( !a->norm_operator &&
             !a->pseudo_action ) {
                ...
                while(i < a->num_name_vars ) {
                        printf(" %s", gconstants[a->name_inst_table[i]]);

                        sprintf(str, "rostopic pub -1 /hola std_msgs/String '%s'", gconstants[a->name_inst_table[i]]);
                        system(str);
                        i++;
                }
...

{
        ...
        system("rostopic pub -1 /hola std_msgs/String OVER");
